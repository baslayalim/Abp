...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 8c983e3c-5e71-4e4a-8e35-ca655fd4f3a9
```

> `8c983e3c-5e71-4e4a-8e35-ca655fd4f3a9` is the password of the certificate, you can change it to any password you want.
